...
| REDIRECT_EXPECTED_MATCHING_CRITERIA           | JSON list of redirect URL matching criteria expected to be present in REDIRECT_URL_CONFIGURATION, used for configuration cross validation                                      | string  |            |
| REDIRECT_URL_CONFIGURATION                    | JSON list of redirect backend URL entries with matching criteria used for Redirect payments                                                                                    | string  |            |
