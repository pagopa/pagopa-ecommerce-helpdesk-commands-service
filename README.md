...
If you want to run the project locally with Spring Boot, you should initialize npg-mock and redirect-mock using the following commands (you need yarn installed on the WSL):
...
yarn json-server ./redirect-server.json --routes ./routes.json --middlewares ./middleware.js --host=0.0.0.0
```
