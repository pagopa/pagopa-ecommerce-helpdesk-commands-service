...
| REDIRECT_EXPECTED_MATCHING_CRITERIA           | JSON list of redirect URL matching criteria expected to be present in REDIRECT_URL_MAPPING, used for configuration cross validation                                            | string  |            |
| REDIRECT_URL_MAPPING                          | JSON list of redirect backend URL entries with matching criteria used for Redirect payments                                                                                    | string  |            |
