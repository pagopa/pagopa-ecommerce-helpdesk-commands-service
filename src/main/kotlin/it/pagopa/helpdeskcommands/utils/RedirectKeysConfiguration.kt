...
class RedirectKeysConfiguration(
    ...
    init {
        ...
        val missingKeys = paymentTypeCodeList
            .stream()
    ...
    fun getRedirectUrlForPsp(
        ...
        return searchResult?.right() ?: Either.Left(
     ...
     * The method has been converted to Kotlin from the ecommerce-commons Java library.
     *
    ...
    private fun searchRedirectUrlForPsp(vararg params: String): URI? {
        ...
        redirectBeApiCallUriMap[key]?.let { return it }
