...
/**
 * Enumeration containing possible types of Redirect configuration. Each enum variant maps to a
 * different configuration property. These are kept separate to separate secrets from common
 * configurations.
 */
